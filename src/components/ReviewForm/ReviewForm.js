                ...
                <form onSubmit={(e) => {
                    ...
                    >
                        ...
                        <div className="rf-starRating">
                            <input type="radio" name="rating" value="1" id="rating1" onChange={(e) => {
                                handleRatingSelect(e)
                            }}/>
                            <label htmlFor="rating1"><span>1</span></label>
                            <input type="radio" name="rating" value="2" id="rating2" onChange={(e) => {
                                handleRatingSelect(e)
                            }}/>
                            <label htmlFor="rating2"><span>2</span></label>
                            <input type="radio" name="rating" value="3" id="rating3" onChange={(e) => {
                                handleRatingSelect(e)
                            }}/>
                            <label htmlFor="rating3"><span>3</span></label>
                            <input type="radio" name="rating" value="4" id="rating4" onChange={(e) => {
                                handleRatingSelect(e)
                            }}/>
                            <label htmlFor="rating4"><span>4</span></label>
                            <input type="radio" name="rating" value="5" id="rating5" onChange={(e) => {
                                handleRatingSelect(e)
                            }}/>
